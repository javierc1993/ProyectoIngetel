...
export class InicioComponent implements OnInit {
  ...
  constructor(private _httpClient: HttpClient, private _formBuilder: UntypedFormBuilder) {     
    ...
    this.statusPO = {
      ...
      labels: ['Error facturacion', 'Pendiente', 'Por facturar', 'Por pagar', 'Finalizado', 'Error pago', 'Por liberar'],
  ...
  updateTotalValues(){
    ...
    this.optionsValuesPO.series = [{
      data: [this.valorTotalPO, this.valorTotalFacturado, this.valorTotalIva, parseFloat((this.valorTotalFacturado + this.valorTotalIva - this.valorTotalRetenciones).toFixed(2)), this.valorTotalPagado]
    }];  
  }
